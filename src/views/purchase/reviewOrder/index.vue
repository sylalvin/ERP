    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['purchase:reviewInvoice:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleUpload"
          v-hasPermi="['purchase:reviewInvoice:upload']"
        >上传</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleDelete"
          v-hasPermi="['purchase:reviewInvoice:delete']"
        >作废</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handlePrint"
          v-hasPermi="['purchase:reviewInvoice:print']"
        >打印</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['purchase:reviewInvoice:download']"
        >导出</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
