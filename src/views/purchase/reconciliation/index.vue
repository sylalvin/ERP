    ...
    <div class="d-flex">
      <div class="container-left">
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
          ...
          <el-form-item label="业务类型" prop="fclass">
            <el-select v-model="queryParams.fclass" placeholder="请选择业务类型" size="small">
              <el-option v-for="(item, index) in fclassList" :key="index" :label="item.fkey" :value="item.fvalue" />
            </el-select>
          </el-form-item> 
          ...
          <el-form-item label="车牌号" prop="fvehiclenum">
            <el-select v-model="queryParams.fvehiclenum" placeholder="请选择车牌号" size="small">
              <el-option v-for="(item, index) in fvehiclenumList" :key="index" :label="item.fnum" :value="item.fid" />
            </el-select>
          </el-form-item> 
        </el-form>
      </div>
      <div class="container-right">
        ...
        <el-table height="100%" v-loading="loading" :data="orderList" class="table" resizable border>
          ...
          <el-table-column label="调度号" align="center" prop="keyid" />
          ...
          <el-table-column label="商品入库数" align="center" prop="fqty" />
          <el-table-column label="容器入库数" align="center" prop="fbottleqty" />
          <el-table-column label="商品出库数" align="center" prop="freturnqty" />
          <el-table-column label="容器出库数" align="center" prop="frecycleqty" />
          <el-table-column label="包装物编码" align="center" prop="fbottleoutcode" />
  ...
  methods: {
    ...
    getDictList() {
      ...
      listVehicle({
        ...
        this.fvehiclenumList = response.rows
      })
    }
  }
};
